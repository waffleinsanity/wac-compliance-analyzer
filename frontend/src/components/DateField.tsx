    ...
    <div ref={rootRef} className={clsx('relative', className)}>
      ...
      {open && (
        <div
          ...
          className="absolute left-0 top-[calc(100%+0.35rem)] z-50 w-[17.5rem] rounded-xl border border-ink-200/80 bg-card p-3 shadow-panel dark:border-ink-700"
        >
              ...
              return (
                <button
                  ...
                  className={clsx(
                    ...
                    inMonth && !selected && 'text-ink-700 hover:bg-ink-100 dark:text-ink-200 dark:hover:bg-ink-800',
